...
[button normal="nodata" target=*save1 cond="kag.bookMarkDates[1] == void"]
[locate x=40 y=170]
...
[button normal="nodata" target=*save2 cond="kag.bookMarkDates[2] == void"]
[locate x=300 y=170]
...
[button normal="nodata" target=*save3 cond="kag.bookMarkDates[3] == void"]
[locate x=560 y=170]
...
[button normal="nodata" target=*save4 cond="kag.bookMarkDates[4] == void"]
[locate x=40 y=380]
...
[button normal="nodata" target=*save5 cond="kag.bookMarkDates[5] == void"]
[locate x=300 y=380]
[emb exp="kag.bookMarkDates[5]" cond="kag.bookMarkDates[5] != void"]

;;;;save6
[locate x=560 y=230]
[button normal=&(kag.getBookMarkFileNameAtNum(6)) target=*save6 cond="kag.bookMarkDates[6] != void"]
[button normal="nodata" target=*save6 cond="kag.bookMarkDates[6] == void"]
[locate x=560 y=380]
